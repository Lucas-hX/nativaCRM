  ...
  return (
    <>
      ...
      <button
        ...
        onClick={onClose}
        className={cn(
          "fixed inset-0 z-30 bg-[#0e0d1c]/80 transition-opacity lg:hidden",
          open
      ...
      >
        ...
        <div className="flex h-[4.5rem] shrink-0 items-center justify-between gap-2 border-b border-sidebar-border px-4">
          ...
          <button
            ...
            onClick={onClose}
            aria-label={t("closeMenu")}
            className="flex h-9 w-9 items-center justify-center text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-foreground lg:hidden"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={cn(
                      ...
                      "relative flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors before:absolute before:inset-y-2 before:left-0 before:w-1 before:bg-transparent lg:py-2",
                      isActive
                        ? "bg-sidebar-accent text-sidebar-foreground before:bg-primary"
        ...
        <div className="shrink-0 border-t border-sidebar-border p-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="flex w-full items-center gap-3 px-3 py-2 text-left transition-colors hover:bg-sidebar-accent focus:bg-sidebar-accent focus:outline-none data-popup-open:bg-sidebar-accent">
